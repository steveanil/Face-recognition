...
class App extends Component {
  // our app will know what the input value is
  constructor(){
    super();
    this.state = initialState;
  }

   //it will update the state with user that we recievied
  loadUser = (data) => {
    this.setState({user: {
      id: data.id,
      name: data.name,
  ...
  //calculates where to draw the box
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {/* Makes the signin Page the first thing u see  */}
        { route === 'home'
          ? <div>
              <Logo />
